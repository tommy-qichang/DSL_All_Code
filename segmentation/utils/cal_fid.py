        ...
        if isrgb:
            ...
            if data.shape[0] == 3 or len(data.shape) == 2 or data.shape[-1] == 3:
                ...
                if fake_h5_ch >=0:
                    ...
                    im_ch.save(os.path.join(real_path, str(idx)+"_"+real_key+"_"+str(fake_h5_ch)+".png"))
                else:
