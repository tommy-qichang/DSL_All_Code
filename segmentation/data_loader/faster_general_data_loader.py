...
class FasterGeneralDataLoader(DataLoader):
    """
    Faster Data Loader which load the hdf5 files first without get the data in each iterations.
...
class GeneralDataset(data.Dataset):
    def __init__(self, h5_filepath, transforms=None, paths=["train"], has_label=True):
        ...
        """
        assert type(paths) is list, "The top keys should be a list."
