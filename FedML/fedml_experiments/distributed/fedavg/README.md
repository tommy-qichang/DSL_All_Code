...
```
sh run_fedavg_distributed_pytorch.sh 10 10 cnn hetero 100 1 20 0.1 femnist "./../../../data/FederatedEMNIST/datasets" sgd 0

##run on background
nohup sh run_fedavg_distributed_pytorch.sh 10 10 cnn hetero 100 10 20 0.1 femnist "./../../../data/FederatedEMNIST/datasets" sgd 0 > ./fedavg-cnn-femnist.txt 2>&1 &
```
