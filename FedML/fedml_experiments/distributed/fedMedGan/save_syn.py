...
from fedml_api.distributed.fedmedgan.utils import float_to_uint_img
...
def create_dataset(args, channel_in, test_bs, sample_rate=0.1):
    if 'brats' in args.dataset:
        from fedml_api.data_preprocessing.brats.data_loader_medgan import GeneralDataset
        ...
        from fedml_api.data_preprocessing.exp2_path.data_loader_medgan import TestDataset
        ...
        from fedml_api.data_preprocessing.exp1_heart.data_loader_medgan import GeneralDataset
