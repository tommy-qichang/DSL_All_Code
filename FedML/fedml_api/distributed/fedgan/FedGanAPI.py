...
def FedML_FedGan_distributed(process_id, worker_number, device, comm, model, train_data_global, test_data_global,
...
def init_client(args, device, comm, process_id, size, model, train_data_local_num_dict,
    ...
    # trainer
    trainer = FedGanTrainer(client_index, train_data_local_dict, train_data_local_num_dict, test_data_local_dict, device,
                            args, model_trainer)
