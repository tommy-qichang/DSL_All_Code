...
class NucleiDataset(BaseDataset):
    ...
    def __init__(self, opt, idx=None):
        ...
        if idx is None and opt.subset ==0:
            h5_name = "train_all.h5"
        elif "subset" in opt and opt.subset ==1:
            h5_name = f"train_breast.h5"
        elif "subset" in opt and opt.subset == 2:
            h5_name = "train_kidney.h5"
        elif "subset" in opt and opt.subset == 3:
            h5_name = "train_liver.h5"
        elif "subset" in opt and opt.subset == 4:
        ...
        self.dcm, self.label, self.labels_ternary, self.weight_maps, self.keys = self.build_pairs(train_db)
    ...
    def build_pairs(self, dataset):
        ...
        return dcm_arr, label_arr, labels_ternary_arr, weight_maps_arr, keys_arr
