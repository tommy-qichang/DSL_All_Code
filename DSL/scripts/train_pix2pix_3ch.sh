...
python train.py --dataroot /share_hd1/db/BRATS/2018 --name brats_multimodality_ch3 --model pix2pix --netG resnet_9blocks --direction AtoB --lambda_L1 100 --dataset_mode brats_3ch --pool_size 0 --gpu_ids 2 --batch_size 4 --num_threads 0 --input_nc 1 --output_nc 3
