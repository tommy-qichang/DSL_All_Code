...
#python train.py --dataroot /share_hd1/db/BRATS/2018 --name brats_gan_hgglgg_perceptionloss100 --model pix2pix --netG resnet_9blocks --direction AtoB --lambda_L1 200 --delta_perceptual 10 --dataset_mode brats_hgglgg --pool_size 0 --gpu_ids 2 --batch_size 12 --num_threads 0
...
python train.py --dataroot /share_hd1/db/BRATS/2018 --name brats_gan_hgglgg --model pix2pix --netG resnet_9blocks --direction AtoB --lambda_L1 100 --delta_perceptual 10 --dataset_mode brats_hgglgg --pool_size 0 --gpu_ids 2 --batch_size 12 --num_threads 0
