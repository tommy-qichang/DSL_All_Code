...
class Fsl3dbModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A_1', 'fake_B_1', 'real_B_1', 'real_A_2', 'fake_B_2','real_B_2','real_A_3', 'fake_B_3', 'real_B_3']
