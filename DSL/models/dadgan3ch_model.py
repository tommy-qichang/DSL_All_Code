...
class Dadgan3chModel(BaseModel):
    ...
    def set_input(self, input):
        ...
        if len(self.real_B) == 4:
            self.real_A_15 = self.real_A[3]
            self.real_B_15_ch1 = grayimg(self.real_B[3][:, 0])
            self.real_B_15_ch2 = grayimg(self.real_B[3][:, 1])
            self.real_B_15_ch3 = grayimg(self.real_B[3][:, 2])
    ...
    def forward(self):
        ...
        if len(self.fake_B) == 4:
            self.fake_B_15_ch1 = grayimg(self.fake_B[3][:, 0])
            self.fake_B_15_ch2 = grayimg(self.fake_B[3][:, 1])
            self.fake_B_15_ch3 = grayimg(self.fake_B[3][:, 2])
