...
class DadganModel(BaseModel):
    ...
    def save_imgs(self,real_batch, visuals, opt, batch_num, real_path, fake_path):
        gt = real_batch['A_0']
        for d_id in range(3):
            real_img = visuals[f'real_B_{d_id}']
            syn_img = visuals[f'fake_B_{d_id}']
            filename = f"{batch_num}_{opt.batch_size}_d{d_id}"
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A_0', 'fake_B_0', 'real_B_0','real_A_1', 'fake_B_1', 'real_B_1','real_A_2', 'fake_B_2', 'real_B_2','real_A_3', 'fake_B_3', 'real_B_3']
    ...
    def forward(self):
        ...
        self.fake_B_0 = self.fake_B[0]
        self.fake_B_1 = self.fake_B[1]
        self.fake_B_2 = self.fake_B[2]
        self.fake_B_3 = self.fake_B[3]
